...
enum eSessionLeaveReason : int {
  SESSION_LEAVE_NORMAL = 0,
  SESSION_LEAVE_DUPLICATE_LOGIN = 1,
  eSessionLeaveReason_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  eSessionLeaveReason_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool eSessionLeaveReason_IsValid(int value);
constexpr eSessionLeaveReason eSessionLeaveReason_MIN = SESSION_LEAVE_NORMAL;
constexpr eSessionLeaveReason eSessionLeaveReason_MAX = SESSION_LEAVE_DUPLICATE_LOGIN;
constexpr int eSessionLeaveReason_ARRAYSIZE = eSessionLeaveReason_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* eSessionLeaveReason_descriptor();
template<typename T>
inline const std::string& eSessionLeaveReason_Name(T enum_t_value) {
  static_assert(::std::is_same<T, eSessionLeaveReason>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function eSessionLeaveReason_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    eSessionLeaveReason_descriptor(), enum_t_value);
}
inline bool eSessionLeaveReason_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, eSessionLeaveReason* value) {
...
template <> struct is_proto_enum< ::Protocol::eSessionLeaveReason> : ::std::true_type {};
template <>
