...
public:
	...
	static void Init()
	{
		...
		sPacketServiceTypeMap[Protocol::eServiceType::SERVICE_TYPE_LOGIN] = [](const uint16 size, const uint16 packetId, const byte* pBuffer, PacketSessionRef& pSession) -> bool
            {
