...
public:
	...
	static NetSendBufferRef MakeSendBuffer(const Protocol::C2S_HEARTBEAT_NOT& packet) { return MakeSendBuffer(packet, packet_id::eHeartbeatPacketId::C2S_HEARTBEAT_NOT); }
...
private:
	...
	static NetSendBufferRef MakeSendBuffer(const T& packet, const uint16 packetId)
	{
		...
		header->id = MAKE_PACKET_HEADER_ID(Protocol::eServiceType::SERVICE_TYPE_HEARTBEAT, packetId);
