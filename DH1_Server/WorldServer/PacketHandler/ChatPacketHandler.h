...
public:
	...
	static NetSendBufferRef MakeSendBuffer(const Protocol::S2S_REALM_CHAT_SUBMIT_NOT& packet) { return MakeSendBuffer(packet, packet_id::S2S_REALM_CHAT_SUBMIT_NOT); }
