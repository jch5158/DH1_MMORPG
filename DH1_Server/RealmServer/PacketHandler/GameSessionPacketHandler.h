...
public:
	...
	static void Init()
	{
		sPacketHandleMap[packet_id::eGameSessionPacketId::S2S_GAME_SESSION_SYNC_ENTER_NOT] = [](const uint16 size, const byte* pBuffer, const PacketSessionRef& pSession) -> bool
		{
			return HandlePacket<Protocol::S2S_GAME_SESSION_SYNC_ENTER_NOT>(size, pBuffer, pSession, HANDLE_S2S_GAME_SESSION_SYNC_ENTER_NOT);
		};
		sPacketHandleMap[packet_id::eGameSessionPacketId::S2S_GAME_SESSION_SYNC_LEAVE_NOT] = [](const uint16 size, const byte* pBuffer, const PacketSessionRef& pSession) -> bool
		{
			return HandlePacket<Protocol::S2S_GAME_SESSION_SYNC_LEAVE_NOT>(size, pBuffer, pSession, HANDLE_S2S_GAME_SESSION_SYNC_LEAVE_NOT);
		};
