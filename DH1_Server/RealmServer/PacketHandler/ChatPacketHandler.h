...
public:
	...
	static void Init()
	{
		sPacketHandleMap[packet_id::eChatPacketId::S2S_REALM_CHAT_SUBMIT_NOT] = [](const uint16 size, const byte* pBuffer, const PacketSessionRef& pSession) -> bool
		{
			return HandlePacket<Protocol::S2S_REALM_CHAT_SUBMIT_NOT>(size, pBuffer, pSession, HANDLE_S2S_REALM_CHAT_SUBMIT_NOT);
		};
