...
public:
	...
	static void Init()
	{
		...
		sPacketHandleMap[packet_id::eLoginPacketId::C2S_LOGOUT_NOT] = [](const uint16 size, const byte* pBuffer, const PacketSessionRef& pSession) -> bool
		{
			return HandlePacket<Protocol::C2S_LOGOUT_NOT>(size, pBuffer, pSession, HANDLE_C2S_LOGOUT_NOT);
		};
